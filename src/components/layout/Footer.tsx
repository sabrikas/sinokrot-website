...
const corporateLinks = [
  ...
  { label: "Uretim Surecimiz", href: "/uretim-surecimiz" },
  { label: "Kalite Politikamiz", href: "/kalite-politikamiz" },
];

const quickLinks = [
  { label: "İletişim", href: "/iletisim" },
  { label: "Cerez Politikasi", href: "/cerez-politikasi" },
  { label: "KVKK Aydinlatma Metni", href: "/kvkk-aydinlatma-metni" },
];
    ...
    <footer className="mt-auto border-t border-gray-200 bg-white">
      ...
      <div className="border-t border-gray-200">
        <div className="mx-auto w-full max-w-7xl px-4 py-4 text-xs text-gray-500 sm:px-6">
          © {new Date().getFullYear()} Sinokrot. Tum haklari saklidir. | Bir Aksu markasıdır.
        </div>
      </div>
    </footer>
  );
